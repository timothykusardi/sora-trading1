...
export default function Home() {
  return (
    <div className="font-sans antialiased bg-[#F7F3EF] min-h-screen flex flex-col">

      {/* HERO SECTION */}
      <section
        className="relative w-full flex flex-col items-center justify-center text-center py-16 px-4"
        style={{ background: "url('/charcoal-hero.jpg') center/cover" }}
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-4">
            <a
              href="#products"
              className="bg-orange-400 hover:bg-orange-500 px-6 py-3 text-white rounded-lg font-semibold shadow"
            >
              Explore Products
            </a>
          </div>
